...
class MarketCalendar:
    ...
    def is_trading_allowed(self, now: datetime.datetime = None) -> bool:
        """
        매매 허용 시간인지 판단.
    ...
    def is_eod_timecut(self, now: datetime.datetime = None) -> bool:
        """
        타임컷(일괄 청산) 시점인지 판단.
        기본: 15:15 (지연일: 16:15)
        """
    ...
    def is_eod_shutdown(self, now: datetime.datetime = None) -> bool:
        """
